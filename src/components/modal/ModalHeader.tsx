...
export default function ModalHeader({ title, desc, isSideModal = false, closeModal }: ModalHeaderProps) {
  return (
    <Fragment>
      {isSideModal ? (
        ...
        <header className="flex items-start justify-between">
          <div className="flex flex-col">
            ...
            {desc && (
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 max-w-md">{desc}</p>
            )}
          </div>
