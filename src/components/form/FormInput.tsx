  ...
  (
    ...
    return (
      <div className={cn("relative w-full", mainClassName)}>
        {label && (
          <label className="block mb-1 font-normal text-base">{label}</label>
        )}
        <div
          className={cn(
        ...
        >
          ...
          <input
            ...
            className={cn(
              "w-full px-4 py-2 bg-transparent focus-visible:outline-none focus-visible:ring text-lg font-medium",
